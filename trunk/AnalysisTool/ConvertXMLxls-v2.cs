// ConvertXMLxls.cs
//  o v1 - ekhan 20070517
//  o v2 - ekhan 20070527 - commented out creation of second EVSview (second worksheet) to cut file creation time in half
...
namespace convertXMLxls
{
    class Program
    {
        ...
        // excel vars
        private static object missing = System.Reflection.Missing.Value;    // needed for some Excel methods
        private static int firstColWidth = 20;
        private static string stringA = "A";        // for building cell_name
        private static string stringB = "B";

        private static Excel.Range excelCell;       // the working/current cell for view1
        private static Excel.Range excelCellView2;  
        private static Excel.Range timestampCell;   // need to record cell location for line insertion
        private static int timeStampLineNum;        // need to record line number for line insertion
        private static string outputFile;
        private static int rowNumber;               // used to keep track of row numbers starting with "Condition" section (for view1)
        private static int rowNumberView2;          // row numbers for view2
        ...
        private static Excel.Range getCell(Excel.Worksheet sheet, string col, int row)
        {
