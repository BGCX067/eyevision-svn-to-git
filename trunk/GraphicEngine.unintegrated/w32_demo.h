...
HBITMAP blank_bitmap(COLORREF bgcolor,int bitmapWidth, int bitmapHeight);
...
//int bitmap_recording_trial(HBITMAP *gbm, struct bitmapWidthHeight *bWidthHeight, int trialNum, int displayX, int displayY, int gridDisplay, UINT32 duration, int fgColorR, int fgColorG, int fgColorB);
...
//struct objPosition *objInitPos(int numObjects, int displayX, int displayY, struct bitmapWidthHeight *bWidthHeight);
